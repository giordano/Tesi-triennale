...
set output 'newton/newton-raggio.tex'
set key bottom center # posizione legenda
set ylabel "$r$ (\\SI{e6}{\\kilo\\metre})" # etichetta asse y
set format y "$%g$"
plot 'newton/newton.dat' using 1:3 title "$e=0$",\
     'newton/newton.dat' using 1:6 title "$e=0.5$",\
     'newton/newton.dat' using 1:9 title "$e=0.8$"
# imposta il secondo file di output
set output 'newton/newton-anomalia_eccentrica.tex'
...
plot 'newton/newton.dat' using 1:2 title "$e=0$",\
     'newton/newton.dat' using 1:5 title "$e=0.5$",\
     'newton/newton.dat' using 1:8 title "$e=0.8$"
# imposta il terzo file di output
set output 'newton/newton-anomalia_vera.tex'
set key top left # posizione legenda
set ylabel "$\\chi$" # etichetta asse y
plot 'newton/newton.dat' using 1:4 title "$e=0$",\
     'newton/newton.dat' using 1:7 title "$e=0.5$",\
     'newton/newton.dat' using 1:10 title "$e=0.8$"
