...
\begin{figure}
  ...
  \begin{tikzpicture}[scale=0.6]
    ...
    \foreach \x in {-5,-3,-1,1,3,5} % varie posizioni del pianeta
      \draw (\x,0) circle (1);
    \draw (-6,-3) node[left] {luminosità} -- (-5,-3) -- (-3,-5) -- (3,-5) --
          (5,-3) -- (6,-3);
...
\end{figure}
Nella Figura~\ref{fig:schema-transito} % TODO: scrivere didascalia descrittiva
                                % che faccia riferimento anche alla curva di
                                % luminosità
...
stella ma leggermente più spostato, come mostrato nella Figura % TODO: inserire
                                % figura e riferimento.
