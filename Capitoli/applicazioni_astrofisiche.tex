...
visuali, quelli cioè in cui entrambi i corpi sono visibili. Vedremo più avanti
...
\begin{figure}
  \centering
  \begin{tikzpicture}
    \input{Immagini/tikz/angolo_inclinazione}
  \end{tikzpicture}
...
\begin{figure}
  ...
  {\begin{tikzpicture}[scale=0.7,font=\footnotesize]
      \input{Immagini/tikz/schema_transito_i_non_90}
    \end{tikzpicture}} \qquad
  \subfloat[][Geometria del sistema\label{fig:transito-i-non-90.b}]
  {\begin{tikzpicture}[scale=0.7,font=\footnotesize]
      \input{Immagini/tikz/geometria_transito_i_non_90}
    \end{tikzpicture}}
  \caption{Transito di un pianeta davanti alla stella compagna nel caso
    $i \neq \pi/2$}
...
\begin{figure}
  \centering
  \subfloat[][$\sqrt{r_1^2-r_2^2}\leq d\leq r_1+r_2$\label{fig:area-coperta.a}]
  {\begin{tikzpicture}[scale=1.1,font=\footnotesize]
      \input{Immagini/tikz/area_coperta1}
    \end{tikzpicture}} \qquad
  \subfloat[][$r_1-r_2 \leq d < \sqrt{r_1^2-r_2^2}$\label{fig:area-coperta.b}]
  {\begin{tikzpicture}[scale=1.1,font=\footnotesize]
      \input{Immagini/tikz/area_coperta2}
    \end{tikzpicture}}
