...
Sia $G$ l'intersezione con la circonferenza della perpendicolare all'asse $x$
innalzata dal punto $Q$. L'angolo $G\widehat{C}P$, dove $C$ è il centro della
circonferenza, è chiamato \emph{anomalia eccentrica} e lo indicheremo con
$\psi$. Al periapside si ha $\chi = \psi = 0$ e all'apoapside
$\chi = \psi = \pi$. I punti $Q=(x_Q,y_Q)$ e $G=(x_Q,y_G)$ hanno la stessa
