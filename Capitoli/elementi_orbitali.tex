...
per via del termine $\sin\psi$, e non ammette soluzione analitica elementare, ma
...
\emph{funzioni di Bessel di ordine intero}, o \emph{funzioni
  cilindriche}~\cites{abramowitz:handbook}{watson:bessel}%
...
\begin{equation}
  ...
  \quad n\in\Z,
\end{equation}
in cui $\gamma$ è un qualsiasi circolo centrato nell'origine. Si dimostra che
\begin{equation}
...
La funzione $J_n(x)$ è chiamata \emph{funzione di Bessel di argomento $x$ e
  ...
  funzione di Bessel}. Si dimostrano inoltre le seguenti formule ricorsive
\begin{subequations}
  \begin{gather}
...
dare un'espressione elementare della funzione $\psi(\phi)$, però possiamo notare
...
\end{equation}
Si dimostra che~\cite[555]{watson:bessel}
\begin{equation}
