...
0$,\footnote{Si
  ...
  $\psi = \omega t$, pertanto possiamo escludere queste situazioni.}
...
soluzione è unica. Dall'equazione di Keplero abbiamo che $\psi$ differisce da
...
finché non troviamo lo zero della funzione.
...
valori dell'eccentricità dell'orbita. Il codice sorgente del programma è
riportato nell'appendice~\ref{cha:soluzione-keplero}.
\begin{figure}
  \centering
  \input{risoluzione-keplero/keplero1}
  \caption{}
  \label{fig:keplero1}
\end{figure}
\begin{figure}
  \centering
  \input{risoluzione-keplero/keplero2}
  \caption{}
  \label{fig:keplero2}
\end{figure}
\begin{figure}
  \centering
  \input{risoluzione-keplero/keplero3}
  \caption{}
  \label{fig:keplero3}
\end{figure}
