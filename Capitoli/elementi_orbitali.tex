...
circonferenza di raggio $a$ e centro l'origine del sistema di riferimento è
\begin{equation}
...
di Newton~-~Raphson, chiamato anche \emph{metodo delle tangenti}, descritto nel
seguente
...
figure~\ref{fig:keplero-anomalia_eccentrica}, \ref{fig:keplero-raggio}
e~\ref{fig:keplero-anomalia_vera}, realizzate con il softawre \verb|gnuplot|,
...
periapside è $t_0 = 0$ e il semiasse maggiore vale $a = \SI{5}{\kilo\metre}$.
\begin{figure}
  \centering
  \input{risoluzione-keplero/keplero-anomalia_eccentrica}
  \caption{Anomalia eccentrica in funzione del tempo}
  \label{fig:keplero-anomalia_eccentrica}
\end{figure}
\begin{figure}
  \centering
  \input{risoluzione-keplero/keplero-raggio}
  \caption{Distanza dal fuoco in funzione del tempo}
  \label{fig:keplero-raggio}
\end{figure}
\begin{figure}
  \centering
  \input{risoluzione-keplero/keplero-anomalia_vera}
  \caption{Anomalia vera in funzione del tempo}
  \label{fig:keplero-anomalia_vera}
\end{figure}
