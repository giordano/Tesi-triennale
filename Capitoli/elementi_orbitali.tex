...
\begin{equation}
  r = a(1-e) + 2ae\sum_{n=1}^{+\infty}\frac{1}{n}\toder{J_n(ne)}{x} - 2ae\sum_{n=1}^{+\infty}\frac{1}{n}\toder{J_n(ne)}{x}\cos(n\phi).
\end{equation}
Si dimostra che
\begin{equation}
...
quindi
\begin{equation}
  \frac{r}{a} = 1 + \frac{e^2}{2} - 2ae \sum_{n=1}^{+\infty} \frac{1}{n}
