...
relativa è periodico, dunque anche la funzione $\psi(\phi)$ è periodica, di
periodo $2\pi$.  La funzione $\ltoder{\psi(\phi)}{\phi}$ è integrabile
nell'intervallo $\mathopen{[}-\pi, \pi\mathclose{]}$ essendo continua, allora è
...
pari e nello sviluppo compariranno solo i termini in seno, cioè
\begin{equation}
