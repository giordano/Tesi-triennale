...
istantaneamente con quella di del corpo reale di massa $m_2$.
...
della particella di massa ridotta rispetto alla particella $M_\textup{T}$ è un
...
residua del corpo. Facciamo l'ipotesi semplificatrice ma non del tutto corretta
che dopo la perdita di massa da parte di $m_1$ la velocità
\begin{equation}
  v^2(\theta) = G(m_1 + m_2)
  \left(
    \frac{2}{r(\theta)} - \frac{1}{a}
...
scegliamo di valutare $r(\theta)$ al periapside, cioè $\theta = \tilde\omega$
perché quando l'orbita è ancora chiusa il sistema è maggiormente legato in
questo punto, pertanto
\begin{equation}
...
\begin{figure}
  ...
  \caption[Orbite dei due corpi]{Nella figura di destra sono riportate le orbite
    ...
    $m_1$. Abbiamo posto $m_1=1$ e $m_2=5$ in unità arbitrarie, i parametri
...
massivo, nell'esempio in figura $m_2$, rimane vicino a questo, il corpo meno
...
$m_2$ sono sempre opposti rispetto al centro di massa durante loro moto
orbitale.
