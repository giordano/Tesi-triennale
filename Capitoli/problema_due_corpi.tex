...
% TODO: i risultati che ottengo adesso sono decisamente più plausibili di quelli
% precedenti, ma devo ancora ricontrollare i calcoli. COMPLETARE PARAGRAFO
\begin{figure}
  \centering
  \input{Immagini/gnuplot/ellisse_vlos}
  \caption{Velocità nella direzione della di vista}
...
nella figura.% TODO: aggiungere immagine come la 47 dello Smart e il riferimento
...
radiale $\dot{r}(\theta)$:%TODO: I CALCOLI SONO DA RISCRIVERE
\begin{equation}
...
\begin{figure}
  ...
  dell'anomalia]{Andamento della velocità lungo la direzione della linea di
    ...
    di orbita ellittica. Il grafico è stato fatto per gli stessi valori di
