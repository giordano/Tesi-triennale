...
\begin{figure}
  ...
  \caption[Andamento della velocità in funzione dell'anomalia.]{Andamento
    qualitativo del modulo quadro della velocità del corpo di massa ridotta in
...
\begin{figure} %TODO: scegliere valori migliori per il grafico
  ...
  centro di massa.]{Andamento qualitativo del potenziale efficace nel problema
    di Keplero in funzione della distanza dal centro di massa. Il grafico
