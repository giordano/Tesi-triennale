...
figura~\ref{fig:ellisse}). Osserviamo inoltre che $r(\pi/2)=p$. Inserendo la~\eqref{eq:rec-semilato}
nella~\eqref{eq:semilato-ellisse} possiamo ricavare l'eccentricità dell'ellisse
\begin{equation}
...
\begin{subequations}
  ...
  \end{align}
\end{subequations}
Quindi, mettendo insieme le relazioni appena trovate, la~\eqref{eq:rec-semilato} e la~\eqref{eq:orbita} risulta
\begin{equation}
  \begin{split}
