...
\begin{figure}
  ...
  \begin{tikzpicture}[font=\footnotesize,scale=2]
    ...
    \draw (-\cuno,0) ellipse (\a*1 and \buno); %ellisse 1
    \draw (0.8,0.8) node {$e=\euno$};
    \draw[dashed] (-\cdue,0) ellipse (\a*1 and \bdue); %ellisse 2
    \draw (-1.2,0.7) node[left] {$e=\edue$};
    \draw[dashdotted] (-\ctre,0) ellipse (\a*1 and \btre); %ellisse 3
...
\begin{figure}
  ...
  {\begin{tikzpicture}[font=\footnotesize,scale=2.5]
      ...
      \draw[->] (0,-0.7) -- (0,0.7) node[above] {$y$}; %asse y
      \draw (-\c,0) ellipse (\a*1 and \b); %ellisse della particella ridotta
