...
\begin{figure}
  ...
  \begin{tikzpicture}[font=\scriptsize,scale=5]
    ...
    \draw[decorate,decoration={brace,raise=3,mirror}] (0,0) -- node[above=4]
                                                      {$a$} (-1,0);
    \draw[decorate,decoration={brace,raise=3}] (0,0) -- node[above=4] {$c$}
                                               (0.8,0);
    \draw[decorate,decoration={brace,raise=3}] (0,0) -- node[left=4] {$b$}
                                               (0,0.6);
    \draw[decorate,decoration={brace,raise=3}] (0.8,0) -- node[left=4] {$p$}
                                               (0.8,0.36);
    \draw[decorate,decoration={brace,raise=3,mirror}] (0.8,0) -- node[below=4]
                                                      {$a-c$} (1,0);
  \end{tikzpicture}
