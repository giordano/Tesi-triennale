...
\end{equation}
La coordinata $\bm{r}$ svolge dunque il ruolo di coordinata generalizzata e la
sua dimensione è uguale al numero di gradi di libertà del sistema. L'equazione
di Lagrange per la coordinata $\bm{r}$ è
\begin{equation}
...
\begin{equation}
  ...
  U(\bm{r})
\end{equation}
L'hamiltoniana non dipende esplicitamente dal tempo, quindi l'energia del
...
\end{equation}
L'hamiltoniana in coordinate polari e con il
potenziale~\eqref{eq:potenziale-gravitazionale} è data da
\begin{equation}
  \begin{split}
...
\section{Orbite dei due corpi}%TODO: inventarsi un titolo decente
\label{sec:orbite-corpi}

\begin{figure}
  \centering
  \input{Immagini/gnuplot/orbite_ellittiche}
  \caption{AGGIUNGERE LA DIDASCALIA.}
