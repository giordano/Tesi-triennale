...
particella relativa nel sistema di riferimento del centro di massa
\begin{equation}
  \label{eq:orbita}
...
che indichiamo con $q_1,\dots,q_n$ e che determinano univocamente il sistema
tenendo conto dei vincoli. Le $q_i$ sono dette \emph{coordinate generalizzate} o
