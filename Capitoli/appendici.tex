...
presenti nella libreria \verb|libreria.c| da me scritta e già riportata
nell'appendice~\ref{cha:soluzione-keplero}. Il \verb|main| del programma è
contenuto nel file \verb|eclissi.c|. Per compilare il programma in ambiente
GNU/Linux ho usato i seguenti comandi da terminale
\begin{verbatim}
$ gcc -c -Wall -pedantic -lm -lgsl -lgslcblas libreria.c
...
% compilazione del documento, ricordarsi di decommentare nella versione finale!
% \lstinputlisting[language=C,numbers=left,numberstyle=\tiny,
% caption={File \texttt{eclissi.c}}]{programmi/eclissi.c}
...
\lstinputlisting[language=gnuplot,
numbers=left,numberstyle=\tiny]{programmi/eclissi.gnuplot}
